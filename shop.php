        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
					...
					<br>
					<strong>
					<?php if($Username != null){echo '<a href="ManageAccount.php?Rol=User">Manage Account</a> |';} ?> 
					<?php if($Username == null){echo '<a href="Login.php?Rol=User">Ingresar</a>';} else {echo '<a href="Logout.php">Cerrar Sección</a>';} ?> | 
